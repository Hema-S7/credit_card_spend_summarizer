...
--First create the db named "northstar_bank_db" in pg admin 
--Create read only credentials from selecting PSQL Tool by right clicking on the db you just created
...
GRANT CONNECT ON DATABASE northstar_bank_db TO rag_readonly;
